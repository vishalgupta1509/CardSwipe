...
import com.example.cardswipedemo.BuildConfig
import com.example.cardswipedemo.util.ErrorBean
...
//    okHttpClientBuilder.addInterceptor(authInterceptor)
    okHttpClientBuilder.connectTimeout(30, TimeUnit.SECONDS)                                // connectTimeout
    okHttpClientBuilder.readTimeout(50, TimeUnit.SECONDS)                                   // readTimeout
    okHttpClientBuilder.writeTimeout(60, TimeUnit.SECONDS)                                  // readTimeout
...
class AuthInterceptor : Interceptor {
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        return originalResponse.newBuilder().code(statusCode).body(bodyString?.toResponseBody(contentType = contentType)).build()
    }
}