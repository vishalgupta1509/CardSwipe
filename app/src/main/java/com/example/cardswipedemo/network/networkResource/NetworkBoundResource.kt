package com.example.cardswipedemo.network.networkResource
...
import com.example.cardswipedemo.network.*
...
//                    setValue(Resource.error(response.errorMessage, response) as Resource<ResultType>)
                    result.addSource(apiResponse) { newData ->
                        try {
                            ...
                            setValue(Resource.error(json.getString("message"), newData) as Resource<ResultType>)
                        } catch (e: JsonSyntaxException ) {
                            setValue(Resource.error(response.errorMessage, newData) as Resource<ResultType>)
